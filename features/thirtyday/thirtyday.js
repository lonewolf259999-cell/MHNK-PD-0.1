...
// ✅ ดึง Discord ID จากคอลัมน์ E (ใช้ colToIndex จาก sheetHelper แล้ว)
...
// ✅ ลบข้อมูลจาก NamePD (ใช้ shared buildClearCellRequests)
async function clearNamePDRow(spreadsheetId, sheetName, rowIndex) {
    const requests = buildClearCellRequests(rowIndex, STANDARD_CLEAR_COLUMNS);
